...
/**
 * This class provides an empty implementation of {@link JDLListener},
 * which can be extended to create a listener which only needs to handle a subset
 * of the available methods.
 */
public class JDLBaseListener implements JDLListener {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 * <p>The default implementation does nothing.</p>
	 */
	@Override public void exitRelation_type(JDLParser.Relation_typeContext ctx) { }
